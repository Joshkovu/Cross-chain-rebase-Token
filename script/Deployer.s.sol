...
contract SetPermissions is Script {
    ...
    function setAdmin(address tokenAddress, address poolAddress) public {
        ...
        TokenAdminRegistry(networkDetails.tokenAdminRegistryAddress).acceptAdminRole(tokenAddress);
        TokenAdminRegistry(networkDetails.tokenAdminRegistryAddress).setPool(tokenAddress, poolAddress);
        vm.stopBroadcast();
    }
}
